...
const Work = () => (
  <div>
    ...
    <Formik
      initialValues={{name: '', email: '',  password: '', age: '', country: '' }}
    //   validate={values => {
    //     const errors = {};
    //     if (!values.email) {
      ...
      {({
        ...
        <div className="flex items-center justify-center h-screen">
          ...
          <div className="flex flex-col">
            ...
            <button
              className="background-color black border border-black-1000 gap-3 rounded px-5 py-3 flex items-center justify-center"
              type=""
